    ...
    fun generate() {
        ...
        viewModelScope.launch {
            ...
            val firstUrl = snapshot.firstFrameUri?.let { uri ->
                ...
                Log.d("VideoGenerateVM", "📤 Set uploadMessage: Uploading first frame...")
                val url = uploadReferenceFrame(uri, "first frame")
                Log.d("VideoGenerateVM", "✅ First frame upload complete: $url")
            ...
            val lastUrl = snapshot.lastFrameUri?.let { uri ->
                ...
                Log.d("VideoGenerateVM", "📤 Set uploadMessage: Uploading last frame...")
                val url = uploadReferenceFrame(uri, "last frame")
                Log.d("VideoGenerateVM", "✅ Last frame upload complete: $url")
            ...
            Log.d("VideoGenerateVM", "✅ Set uploadMessage: Frames uploaded • Submitting request...")
