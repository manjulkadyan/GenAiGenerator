...
private object FakeDataStore {
    val models: List<AIModel> = listOf(
        AIModel(
            ...
            exampleVideoUrl = "https://storage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4",
        ...
        AIModel(
            ...
            exampleVideoUrl = "https://storage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4",
